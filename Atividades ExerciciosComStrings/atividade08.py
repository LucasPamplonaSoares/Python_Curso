...
expressao = str(input("Escreva uma expressão: ")).upper().replace(" ", "")
expressao_inversa = expressao[::1]
if expressao == expressao_inversa:
    print(f"É palíndromo, pois, {expressao} --> {expressao_inversa}.")
else:
